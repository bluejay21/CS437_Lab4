...
clientEndPoint = "a2e5kmx3udhg78-ats.iot.us-east-2.amazonaws.com"
...
class MQTTClient:
    ...
    def publish(self, Payload="payload"):
        ...
        self.client.subscribeAsync("myVehicleTopic", 0, ackCallback=self.customSubackCallback)
        
        self.client.publishAsync("myVehicleTopic", Payload, 0, ackCallback=self.customPubackCallback)
